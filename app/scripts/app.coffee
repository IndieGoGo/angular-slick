      ...
      initializeSlick = () ->
        $timeout(() ->
          ...
          slider.slick
            ...
            prevArrow: if scope.prevArrow then $(scope.prevArrow).prop('outerHTML') else undefined
            nextArrow: if scope.nextArrow then $(scope.nextArrow).prop('outerHTML') else undefined
